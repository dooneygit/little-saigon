...
export const metadata = {
  ...
  description:
    "Get in touch with Little Saigon Nails & Spa in Hamilton. Visit our nail salon, book appointments, or ask questions — we’re here to help.",
  keywords: [
      ...
      <main className="overflow-x-hidden pt-[11rem] sm:pt-[12rem] flex flex-col space-y-10 md:flex-row min-h-screen px-4 sm:px-6 md:px-8 animate-[fadeIn_1s_ease-out_forwards]">
        <section className="flex-1 min-w-0 flex flex-col items-center pt-8 space-y-8">
          <div className="text-center">
            ...
            <ul className="font-markazi text-[1.5rem] sm:text-[2rem] text-gray-700">
          ...
          <div className="text-center">
            <h1 className="font-markazi text-[2.5rem] sm:text-[3rem] text-gray-700">HOURS</h1>
            <ul className="font-markazi text-[1.3rem] sm:text-[1.7rem] text-gray-700">
          ...
          <div className="text-center">
            <h1 className="font-markazi text-[2.5rem] sm:text-[3rem] text-gray-700">FOLLOW US</h1>
            <div className="flex justify-center space-x-8">
              <Socials
                href="https://www.facebook.com/littlesaigonnails/"
                icon={<FaFacebook size={50} className="text-blue-600 hover:-translate-y-1 duration-300" />}
              />
              <Socials
                href="https://www.instagram.com/littlesaigonnails_hamilton/"
                icon={<FaInstagram size={50} className="text-fuchsia-500 hover:-translate-y-1 duration-300" />}
              />
            </div>
          </div>
        </section>
        ...
        <div className="flex-1 min-w-0">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5814.864428819937!2d-79.86397698809252!3d43.22139698013084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882c9a4dda8fffff%3A0x84bdb89532de0ea8!2sLittle%20Saigon%20Nails%20%26%20Spa!5e0!3m2!1sen!2sca!4v1746143680067!5m2!1sen!2sca"
            className="w-full h-[600px] md:h-full border-0"
            allowFullScreen
            loading="lazy"
